...
const Page = () => {
  ...
  return (
    <div className="bg-black">
      <PortfolioDetail detailObject={claclaws} delivery={projectDelivarables} bannerImage="/images/beautyBanner.png" prev="/portfolio/clash-of-the-claws" next="/portfolio/claclaws">
