              ...
              <div className="flex mt-5 gap-x-[80px] flex-wrap gap-y-5 pb-3">
                <div className="flex flex-col gap-y-3">
                  ...
                  <div className="flex flex-col">
                    <p className="font-syne font-[500] text-[#CFDDE8]">portnew@gmail.com</p>
                    <p className="font-syne font-[500] text-[#CFDDE8]">+1 548 882 3921</p>
                  </div>
                </div>
                <div className="flex flex-col gap-y-3 pb-6">
                  <h3 className="font-syne font-[500] text-[#8FA8BD]">Location</h3>
                  <div className="flex-col">
                    <p className="font-syne font-[500] text-[#CFDDE8]">In New York, USA</p>
                    <p className="font-syne font-[500] text-[#CFDDE8]">Suvastu</p>
                  </div>
                </div>
              </div>
